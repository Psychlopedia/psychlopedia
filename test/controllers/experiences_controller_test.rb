...
class ExperiencesControllerTest < ActionController::TestCase
  ...
  test "should create experience" do
    assert_difference('Experience.count') do
      post :create, experience: { body: @experience.body, hearts: @experience.hearts, pseudonym: @experience.pseudonym, title: @experience.title }
    end
  ...
  test "should update experience" do
    patch :update, id: @experience, experience: { body: @experience.body, hearts: @experience.hearts, pseudonym: @experience.pseudonym, title: @experience.title }
    assert_redirected_to experience_path(assigns(:experience))
  end
